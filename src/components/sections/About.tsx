      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="aspect-square relative rounded-2xl overflow-hidden bg-gray-200">
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
              <div>
                ...
                <p className="text-gray-600">Sulaiman Shinwari</p>
              </div>
              <div>
                <p className="font-medium">Email:</p>
                <p className="text-gray-600">sulaimanshinwari830@gmail.com</p>
              </div>
              <div>
